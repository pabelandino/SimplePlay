...
## Summary
- 1619 nodes · 3820 edges · 76 communities (70 shown, 6 thin omitted)
...
### Community 38 - "UUID"
Cohesion: 0.08
Nodes (10): Bool, TimeInterval, ImportPanelKind, audioFiles, folder, Float, Int, UInt8 (+2 more)
...
### Community 41 - "View"
Cohesion: 0.16
Nodes (14): .assignModeToggle, Configuration, AudioDropOverlay, .body, String, TimelineEmptyDropHint, .body, DAWTheme (+6 more)
...
Cohesion: 0.16
Nodes (17): Bool, String, Void, ToolbarMenuButtonStyleModifier, TopToolbarView, .importButton, .importMenuItems, .isCompact (+9 more)

### Community 67 - "WorkspaceViewModel"
Cohesion: 0.07
Nodes (19): ClosedRange, Date, DAWProject, Set, WorkspaceViewModel, .activePitchTrack, .activePlaybackSection, .canSaveDirectlyToCurrentURL (+11 more)
...
- **Why does `ArrangementSection` connect `ArrangementSection` to `DAWProject`, `SectionPlaybackStatus`, `Sendable`, `WorkspaceViewModel`, `AudioSampleRate`, `TimeInterval`, `SectionMarkerChipView`, `MIDIInputService`, `Codable`, `PropertiesSidebarView`, `MIDIMappingBarView`, `SwiftUI`, `SectionPlaybackMode`, `CodingKeys`?**
